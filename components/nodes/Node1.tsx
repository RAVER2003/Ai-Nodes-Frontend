...
function Node1({ id,data,isConnectable }:{id:string,data:{value:string},isConnectable:boolean}) {
...
updateNodeInternals(id)
  ...
  return (
    <div className='p-3 border-2 bg-slate-400 border-cyan-400 rounded-lg'>
      ...
      <div>
        <button className='bg-black text-white rounded-lg px-3 py-2' onClick={handleclick}>Node1 </button>
      </div>
